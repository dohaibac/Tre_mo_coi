 <footer class="footer">
	<div class="row">
		<p>© Evizi Team. Website <?php bloginfo('name'); ?>, LP. All Rights Reserved.</p>
	</div>
  </footer>
  ...
  <script src="<?php echo get_template_directory_uri(); ?>/js/foundation/foundation.interchange.js"></script>
