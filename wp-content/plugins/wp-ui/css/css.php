...
if (!empty($css_content)) {
    echo str_ireplace(array('url("images', 'url( "images', "url('images", "url( 'images"), array('url("themes/images', 'url( "themes/images', "url('themes/images", "url( 'themes/images"), $css_content);
}
